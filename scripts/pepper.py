...
map_path = "/home/nao/.local/share/Explorer/2014-04-04T004104.191Z.explo"
...
#        self.listen(data.data)
    ...
    def display(self, data):
        ...
        try:
            ...
            if data == "hide": #Only works for images

                r = self.tabletService.hideImage()
